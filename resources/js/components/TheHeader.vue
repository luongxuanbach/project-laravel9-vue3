<template>
    <div class="container-fluid">
        <div class="row text-white" style="background-color: #0c713d; padding: 1rem;">
            ...
            <div class="col-10 col-sm-9 d-flex align-item-center justify-content-center justify-content-sm-start">
                <img src="../assets/logo.webp" alt="logo" height="32" width="34" class="ms-3 me-3"
    ...
    <a-drawer v-model:visible="visible" title="Category" placement="left">
        <TheMenu />
    </a-drawer>

    <a-drawer v-model:visible="visible_user" title="Account" placement="right">
        <p>Some contents...</p>
        <p>Some contents...</p>
        <p>Some contents...</p>
    </a-drawer>
